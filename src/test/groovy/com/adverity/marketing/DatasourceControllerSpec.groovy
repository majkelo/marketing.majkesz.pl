...
class DatasourceControllerSpec extends Specification implements ControllerUnitTest<DatasourceController>, DomainUnitTest<Datasource> {
	...
	void "index: returns the correct response"() {
		given:
			controller.datasourceService = Mock(DatasourceService) {
				1 * list(_) >> []
			}
